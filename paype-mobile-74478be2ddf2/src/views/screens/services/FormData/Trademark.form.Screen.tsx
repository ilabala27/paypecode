...
import NavServiceUtils from '@controllers/utils/NavService.utils'; 9
...
import { states, trademark } from '@models/static/adminSlice.static';
...
export default ({ route, navigation }: INavigationProps2) => {
    ...
    const [formKeys, setFormKeys] = useState([
        "customer_name", "company_name", "contact_number", "customer_email", "customer_state",
        "customer_address", "remarks", "service_type"
    ...
    const [form, setForm] = useState({
        ...
        service_type_validation: [
            { method: "isReq", params: { label: 'Service' } }
        ],
    })
        ...
        <View style={design.GENERIC_SCREEN_P}>
            <MainHeader
                render={[
                    ...
                    { type: "Title", title: "TRADEMARKS & COPYRIGHTS" },
                    { type: "Icon" },
                ]}
            />
            {isLoading ? <Loader /> :
