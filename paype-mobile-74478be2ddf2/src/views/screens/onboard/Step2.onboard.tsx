    ...
    return (
        <View style={design.GENERIC_SCREEN_P}>
            <View style={design.GENERIC_SCREEN_S}>
                <Image
                    source={Images.onBoardSlider2}
                    style={design.GENERIC_IMAGE}
                />
            </View>
            <View style={styles.bottomContainer}>
                <View style={styles.titleContainer}>
                    <Text style={design.GENERIC_TEXT_TITLE_P}>{t('onBoard.step2.title_prefix')}</Text>
                    <Text style={design.GENERIC_TEXT_TITLE_P}>{t('onBoard.step2.title_suffix')}</Text>
                </View>
                <View style={styles.contentconatiner}>
                    <Text numberOfLines={3} style={design.GENERIC_TEXT_CONTENT_S}>{t('onBoard.step2.content')}</Text>
                </View>
                <View style={styles.footerContainer}>
                    ...
                    <TouchableOpacity
                        onPress={() => NavigationServiceUtils.navigate(NavKeys.ONBOARD_STEP3)}
